...
class NumberDisplayAdapter (private val numbers: Array<Int>, private val lambdaSizer: (Int)->Unit) : RecyclerView.Adapter<NumberDisplayAdapter.NumberViewHolder>() {
    ...
    inner class NumberViewHolder (layout: View) : RecyclerView.ViewHolder (layout) {
        ...
        init {
            textView.setOnClickListener { lambdaSizer(numbers[adapterPosition]) }
        }
    }
